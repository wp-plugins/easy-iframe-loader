...
<p><?php _e('<strong><i>important:</i></strong> When entering a value either enter a PX value without the px at the end or a percentage value, remembering to leave the % sign at the end. The amazon sizes applies to an A Store iFrame only','iframe-loader'); ?></p>
 ...
 <p><?php _e('Yep you read it right, I am expecting a baby son in May 2011, and he will need Diapers/Napies and much more, so I need your help just like you have received mine.','iframe-loader'); ?></p>
...
<img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1"><br>
 ...
 <p><?php _e('All amounts valued, but anyone who makes a 50euro or more donation can offer a name for the baby also! (you never know you might have a great one)','iframe-loader'); ?></p>
        </div>
